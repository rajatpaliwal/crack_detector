...
model_file_url = 'https://drive.google.com/uc?export=download&id=1ZfcUi3idAWDyltO4ye97ERZKyOUANAwH'
...
async def setup_model():
    ...
    #model = load_model(dict(MODEL_PATH)) # Load your Custom trained model
